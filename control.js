...
var leleven = [boxes, {x:width/6,y:height/5,width:40,height:(height/5)*4}, {x:width/6,y:(height)*(2/5),width:width/8,height:40}, {x:0,y:(height)*(3/5),width:width/8,height:40}, {x:600,y:500,width:40,height:40}, {x:width/6,y:height-30,width:width,height:40, nono:true}, [970,1000,470,481,1,ltwelve,'Level 11'] ]
